        ...
        <div className="sys-table-container mb-8 rounded-lg overflow-hidden border border-cyan-900/30 bg-slate-900/40">
          <table className="sys-table w-full">
            ...
            <tbody>
              ...
              <tr className="border-b border-slate-800/50">
                <td className="p-3 text-cyan-400 font-bold text-xs">TITLE</td>
                <td className="p-3 text-white text-xs">WOLF SLAYER</td>
              </tr>
              <tr className="border-b border-slate-800/50">
              ...
              <tr>
                ...
                <td className="p-3">
                  <div className="flex items-center gap-3">
                    ...
                    <div className="h-1.5 w-24 bg-slate-800 relative overflow-hidden rounded-full">
                      <div 
